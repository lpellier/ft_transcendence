...
# curl -H "Authorization: Bearer `grep jwt- cookie.txt | cut -d "   " -f 7`" --cookie cookie.txt --cookie-jar cookie.txt "http://127.0.0.1:3001/auth/google-authenticator" -d "value="
